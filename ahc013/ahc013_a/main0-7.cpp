				...
				auto rsearch = [&]() -> void {
					...
					rep(i, n) {
						...
						rep(j, n) {
							...
							else if (li!=-1 && c[i][li]==(char)('1'+ord[min(k-1,i1/2*2+(1-i1%2))])) {
								pli = li;
								li = j;
							}
							else li = pli = -1;
				...
				auto csearch = [&]() -> void {
					...
					rep(i, n) {
						...
						rep(j, n) {
							...
							else if (ui!=-1 && c[ui][i]==(char)('1'+ord[min(k-1,i1/2*2+(1-i1%2))])) {
								pui = ui;
								ui = j;
							}
							else ui = pui = -1;
			...
			auto rsearch = [&]() -> void {
				...
				rep(i, n) {
					...
					rep(j, n) {
						...
						else if (li!=-1 && nc[i][li]==(char)('1'+mord[min(k-1,i1/2*2+(1-i1%2))])) {
							pli = li;
							li = j;
						}
						else li = pli = -1;
			...
			auto csearch = [&]() -> void {
				...
				rep(i, n) {
					...
					rep(j, n) {
						...
						else if (ui!=-1 && nc[ui][i]==(char)('1'+mord[min(k-1,i1/2*2+(1-i1%2))])) {
							pui = ui;
							ui = j;
						}
						else ui = pui = -1;
